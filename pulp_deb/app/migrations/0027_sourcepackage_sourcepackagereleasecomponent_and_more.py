        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "release_component",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="deb.releasecomponent"
                    ),
                ),
                (
                    "source_package",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="deb.sourcepackage"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "release",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="deb.releasefile"
                    ),
                ),
            ],
            options={
